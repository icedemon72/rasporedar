import { addSchedule, editSchedule, getAllSchedulesInInstitution } from '../services/scheduleService.js';
...
export const handleAddSchedule = async (req, res) => {
  try {
    ...
    const done = await addSchedule(null, '65e7455fa456e109c48a162e', req.body);
